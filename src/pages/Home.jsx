  ...
  if (posts.length === 0) {
    return (
      <div className='m-0 w-full py-8 mt-4 text-center'>
        <Container>
          <h1 className='text-4xl sm:text-6xl mb-20 text-blue-200 font-serif'> Riverside: Creativity Reimagined </h1>
          <div className='flex flex-col sm:flex-row gap-10 mb-20'>
            <div className='sm:w-2/3 mb-5 flex flex-col justify-center'>
              ...
              <p className='text-xl mx-5 text-gray-300'>
                Welcome to Riverside.com, a space where you can express your thoughts and creativeness in the form of your writings and statements. Whether you are here to explore perspectives or provide your valuable opinions or simply indulge time in quality reading, we have got you covered.
              </p>
            </div>
          ...
          <div className='flex flex-col sm:flex-row-reverse gap-10 mb-20'>
            <div className='sm:w-2/3 mb-5 flex flex-col justify-center'>
              <h3 className='sm:text-5xl text-2xl mb-10 font-serif'> About Riverside </h3>
                <p className='text-xl mx-5 text-gray-300'>
                  Riverside was born for a desire to connect with like-minded individuals across the globe. Our blog covers a diverse range of topics, including:
                  <br /><br />
                  <ul>
          ...
          <div className='flex flex-col sm:flex-row gap-10 mb-20'>
            <div className='sm:w-2/3 mb-5 flex flex-col justify-center'>
              <h3 className='sm:text-5xl text-2xl mb-10 font-serif'> Our Mission </h3>
                <p className='text-xl mx-5 text-gray-300'>
                  At Riverside, the mission is to inform, inspire, and ignite thoughtful conversations. Believing in the power of words to shape minds and change the world where each article is crafted with care and infused with unique voice.
                </p>
            </div> 
            <div className='sm:w-1/3 flex flex-col justify-center'>
          ...
          <div className='flex flex-col sm:flex-row-reverse gap-10 mb-20'>
            <div className='sm:w-2/3 mb-5 flex flex-col justify-center'>
              <h3 className='sm:text-5xl text-2xl mb-10 font-serif'> Want to Get Involved? </h3>
                <p className='text-xl mx-5 text-gray-300'>
                  We love hearing from our readers! If you have ideas, suggestions, or just want to say hello, feel free to contact us. Interested in writing for Riverside? <br /> Just Sign Up and start writing your thoughts.
                </p>
            </div> 
            <div className='sm:w-1/3 flex flex-col justify-center'>
          ...
          <p className='text-xl mt-30'>Thank you for visiting Riverside. We hope you enjoy your time here and find content that resonates with you. Happy reading!</p>
        </Container>
      </div>
    )
  }
